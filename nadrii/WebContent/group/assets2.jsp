			...
			<div class="container">
				...
				<div class="row">
					<div class="4u 12u$(mobile)">
						<article class="item">
							<a href="#" class="image fit"><img
								src="../resources/assets/images/pic02.jpg" alt="" /></a>
							<header>
								<h3>Ipsum Feugiat</h3>
							</header>
						</article>
						<article class="item">
							<a href="#" class="image fit"><img
								src="../resources/assets/images/pic03.jpg" alt="" /></a>
							<header>
					...
					<div class="4u 12u$(mobile)">
						<article class="item">
							<a href="#" class="image fit"><img
								src="../resources/assets/images/pic04.jpg" alt="" /></a>
							<header>
								<h3>Magna Nullam</h3>
							</header>
						</article>
						<article class="item">
							<a href="#" class="image fit"><img
								src="../resources/assets/images/pic05.jpg" alt="" /></a>
							<header>
								<h3>Natoque Vitae</h3>
							</header>
						</article>
					...
					<div class="4u$ 12u$(mobile)">
						<article class="item">
							<a href="#" class="image fit"><img
								src="../resources/assets/images/pic06.jpg" alt="" /></a>
							<header>
						...
						<article class="item">
							<a href="#" class="image fit"><img
								src="../resources/assets/images/pic07.jpg" alt="" /></a>
							<header>
		...
		<section id="about" class="three">
			<div class="container">
				...
				<a href="#" class="image featured"><img
					src="../resources/assets/images/pic08.jpg" alt="" /></a>
