					...
					success : function(JSONData, status) {
						...
						for( i=0;i<documents.length;i++){
							...
							if(i==documents.length-1){
								...
								console.log(JSONData.meta.total_count%4);
								console.log(JSONData.meta.total_count/4);
						...
						$('div.result').bind('click', function() {
							...
							console.log(index);
							var x = ""+documents[index].x;
							var y = ""+documents[index].y;
							console.log(x +", "+ y);
							...
							console.log("marker : "+marker.getClickable());
							marker.setMap(map);
						})
					}
				})
	...
	<div class="container">
		...
		<div class="col-sm-7">
			<div align="center">
				...
				<div align="right">
					<br/>
					<p><a class="btn btn-primary btn-sm" href="#" role="button">추가하기</a></p>
				</div>
			</div> 
		</div>
	</div>
