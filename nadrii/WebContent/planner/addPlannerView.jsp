			...
			function() {
				$("#save").on(
						...
						function() {
							...
							$("form[name='addPlanner']").attr("method", "POST")
									.attr("action", "/planner/addPlanner")
									.submit();
...
<body>
	...
	<div style="width: 30%; height: 750px; float: left; overflow: auto">
		<form name="addPlanner">
			<div class="container-fulid">

				<div class="row">
					<div class="col-md-12">
						플래너 제목 : <input type="text" name="title" value="" /> <input
							type="button" id="save" value="플래너 저장" />
						<hr>
					</div>
