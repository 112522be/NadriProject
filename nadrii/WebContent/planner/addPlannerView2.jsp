...
<body>
		...
		<form name="addPlanner">
			<div style="width:30%; height:700px; float:left; overflow:auto">
				...
				<div class="row">
				<div class = "col-md-12">
					플래너 제목 : <input type = "text" name="title" value=""/><hr>
				</div>
				<div class ="col-md-2" id="subPointer">
...
<script language="JavaScript" src="../resources/js/map.js?version=180202.2250"></script>
